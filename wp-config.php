...
define( 'WP_CONTENT_URL', 'https://YOUR_SITE_URL_HERE/assets' );
...
// در بسیاری از موارد، تنها با تعریف WP_CONTENT_DIR و WP_CONTENT_URL، وردپرس
// پوشه‌های module و skin را در داخل assets پیدا خواهد کرد.
define( 'WP_PLUGIN_DIR', dirname( __FILE__ ) . '/assets/module' );
define( 'WP_PLUGIN_URL', 'https://YOUR_SITE_URL_HERE/assets/module' );

// توجه: برای پوشه پوسته‌ها (skin)، معمولاً تعریف WP_CONTENT_DIR و WP_CONTENT_URL کافی است
// و وردپرس پوشه 'skin' را درون 'assets' پیدا خواهد کرد.
// اگر مشکلی در شناسایی پوسته‌ها پیش آمد، می‌توان از register_theme_directory() استفاده کرد،
// اما ابتدا بدون آن تست کنید.
